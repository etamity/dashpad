...
exports.init = function(host, defaultOptions, defaultParams) {
    ...
    const getCrumb = function(requestOptions, callback) {
      const crumbToken = Config.get(`settings.platform.jenkins._crumb`);
        if (crumbToken) {
            return callback(null, crumbToken);
        }
        ...
        request(getCrumbOptions, function(error, response, body) {
            ...
            Config.set(`settings.platform.jenkins._crumb`, crumb);
            callback(null, crumb);
        });
    };
    ...
    \*************************************/
         ...
         * @param {function} callback
         */
        last_build_console_output: function(jobName, customParams, callback) {
            [jobName, customParams, callback] = doArgs(arguments, [
                'string',
                ['object', {}],
                'function',
    ...
    \*************************************/
        ...
        update_config: function(
            ...
            [jobName, modifyFunction, customParams, callback] = doArgs(
                arguments,
                ['string', 'function', ['object', {}], 'function']
            );
